...
const idList<bindingLayoutType_t, TAG_RENDER> rpMinimalSet0Layouts = { BINDING_LAYOUT_DEFAULT, BINDING_LAYOUT_DEFAULT_SKINNED, BINDING_LAYOUT_CONSTANT_BUFFER_ONLY, BINDING_LAYOUT_CONSTANT_BUFFER_ONLY_SKINNED, BINDING_LAYOUT_BINK_VIDEO };

const idList<renderParm_t, TAG_RENDER> rpMinimalSet1 = { RENDERPARM_SCREENCORRECTIONFACTOR, RENDERPARM_WINDOWCOORD, RENDERPARM_MVPMATRIX_X, RENDERPARM_MVPMATRIX_Y, RENDERPARM_MVPMATRIX_Z, RENDERPARM_MVPMATRIX_W, RENDERPARM_PROJMATRIX_Z, RENDERPARM_OVERBRIGHT };

const idList<bindingLayoutType_t, TAG_RENDER> rpMinimalSet1Layouts = { BINDING_LAYOUT_POST_PROCESS, BINDING_LAYOUT_TAA_MOTION_VECTORS };

const idList<renderParm_t, TAG_RENDER> rpMinimalSet2 = { RENDERPARM_SCREENCORRECTIONFACTOR, RENDERPARM_WINDOWCOORD, RENDERPARM_MODELMATRIX_X, RENDERPARM_MODELMATRIX_Y, RENDERPARM_MODELMATRIX_Z, RENDERPARM_MODELMATRIX_W, RENDERPARM_JITTERTEXSCALE, RENDERPARM_JITTERTEXOFFSET };

const idList<bindingLayoutType_t, TAG_RENDER> rpMinimalSet2Layouts = { BINDING_LAYOUT_POST_PROCESS_FINAL, BINDING_LAYOUT_DRAW_AO, BINDING_LAYOUT_DRAW_AO1 };

const idList<renderParm_t, TAG_RENDER> rpNominalSet3 = { RENDERPARM_SCREENCORRECTIONFACTOR, RENDERPARM_BUMPMATRIX_S, RENDERPARM_BUMPMATRIX_T, RENDERPARM_VERTEXCOLOR_MODULATE, RENDERPARM_VERTEXCOLOR_ADD, RENDERPARM_COLOR, RENDERPARM_MVPMATRIX_X, RENDERPARM_MVPMATRIX_Y, RENDERPARM_MVPMATRIX_Z, RENDERPARM_MVPMATRIX_W, RENDERPARM_MODELVIEWMATRIX_X, RENDERPARM_MODELVIEWMATRIX_Y, RENDERPARM_MODELVIEWMATRIX_Z, RENDERPARM_TEXTUREMATRIX_S, RENDERPARM_TEXTUREMATRIX_T, RENDERPARM_TEXGEN_0_ENABLED };

const idList<bindingLayoutType_t, TAG_RENDER> rpNominalSet3Layouts = { BINDING_LAYOUT_GBUFFER, BINDING_LAYOUT_GBUFFER_SKINNED };

const idList<renderParm_t, TAG_RENDER> rpNominalSet4 = { RENDERPARM_VERTEXCOLOR_MODULATE, RENDERPARM_VERTEXCOLOR_ADD, RENDERPARM_COLOR, RENDERPARM_MVPMATRIX_X, RENDERPARM_MVPMATRIX_Y, RENDERPARM_MVPMATRIX_Z, RENDERPARM_MVPMATRIX_W, RENDERPARM_TEXTUREMATRIX_S, RENDERPARM_TEXTUREMATRIX_T, RENDERPARM_TEXGEN_0_S, RENDERPARM_TEXGEN_0_T, RENDERPARM_TEXGEN_0_Q, RENDERPARM_TEXGEN_0_ENABLED, RENDERPARM_TEXGEN_1_S, RENDERPARM_TEXGEN_1_T, RENDERPARM_ALPHA_TEST };

const idList<bindingLayoutType_t, TAG_RENDER> rpNominalSet4Layouts = { BINDING_LAYOUT_TEXTURE, BINDING_LAYOUT_TEXTURE_SKINNED, BINDING_LAYOUT_FOG, BINDING_LAYOUT_FOG_SKINNED, BINDING_LAYOUT_BLENDLIGHT, BINDING_LAYOUT_BLENDLIGHT_SKINNED };

const idList<renderParm_t, TAG_RENDER> rpNominalSet5 = { RENDERPARM_LOCALVIEWORIGIN, RENDERPARM_VERTEXCOLOR_MODULATE, RENDERPARM_VERTEXCOLOR_ADD, RENDERPARM_COLOR, RENDERPARM_MVPMATRIX_X, RENDERPARM_MVPMATRIX_Y, RENDERPARM_MVPMATRIX_Z, RENDERPARM_MVPMATRIX_W, RENDERPARM_MODELMATRIX_X, RENDERPARM_MODELMATRIX_Y, RENDERPARM_MODELMATRIX_Z, RENDERPARM_MODELMATRIX_W, RENDERPARM_WOBBLESKY_X, RENDERPARM_WOBBLESKY_Y, RENDERPARM_WOBBLESKY_Z, RENDERPARM_CASCADEDISTANCES };

const idList<bindingLayoutType_t, TAG_RENDER> rpNominalSet5Layouts = { BINDING_LAYOUT_WOBBLESKY, BINDING_LAYOUT_NORMAL_CUBE, BINDING_LAYOUT_NORMAL_CUBE_SKINNED };

const idList<renderParm_t, TAG_RENDER> rpNominalSet6 = { RENDERPARM_SCREENCORRECTIONFACTOR, RENDERPARM_WINDOWCOORD, RENDERPARM_COLOR, RENDERPARM_MVPMATRIX_X, RENDERPARM_MVPMATRIX_Y, RENDERPARM_MVPMATRIX_Z, RENDERPARM_MVPMATRIX_W, RENDERPARM_MODELMATRIX_X, RENDERPARM_MODELMATRIX_Y, RENDERPARM_MODELMATRIX_Z, RENDERPARM_MODELMATRIX_W, RENDERPARM_OVERBRIGHT, RENDERPARM_GLOBALLIGHTORIGIN, RENDERPARM_JITTERTEXSCALE, RENDERPARM_JITTERTEXOFFSET, RENDERPARM_CASCADEDISTANCES };

const idList<bindingLayoutType_t, TAG_RENDER> rpNominalSet6Layouts = { BINDING_LAYOUT_SSGI, BINDING_LAYOUT_SSGI_SKINNED };

const idList<renderParm_t, TAG_RENDER> rpNominalSet7 = { RENDERPARM_WINDOWCOORD, RENDERPARM_MVPMATRIX_X, RENDERPARM_MVPMATRIX_Y, RENDERPARM_MVPMATRIX_Z, RENDERPARM_MVPMATRIX_W, RENDERPARM_PROJMATRIX_Y, RENDERPARM_PROJMATRIX_W, RENDERPARM_MODELVIEWMATRIX_Z, RENDERPARM_ENABLE_SKINNING, RENDERPARM_ALPHA_TEST, RENDERPARM_USER0, RENDERPARM_USER1, RENDERPARM_USER2, RENDERPARM_USER3, RENDERPARM_USER4, RENDERPARM_USER5 };

const idList<bindingLayoutType_t, TAG_RENDER> rpNominalSet7Layouts = { BINDING_LAYOUT_POST_PROCESS_INGAME };

const idList<renderParm_t, TAG_RENDER> rpMaximalSet8 = { RENDERPARM_SCREENCORRECTIONFACTOR, RENDERPARM_WINDOWCOORD, RENDERPARM_DIFFUSEMODIFIER, RENDERPARM_SPECULARMODIFIER, RENDERPARM_LOCALLIGHTORIGIN, RENDERPARM_LOCALVIEWORIGIN, RENDERPARM_BUMPMATRIX_S, RENDERPARM_BUMPMATRIX_T, RENDERPARM_DIFFUSEMATRIX_S, RENDERPARM_DIFFUSEMATRIX_T, RENDERPARM_SPECULARMATRIX_S, RENDERPARM_SPECULARMATRIX_T, RENDERPARM_VERTEXCOLOR_MODULATE, RENDERPARM_VERTEXCOLOR_ADD, RENDERPARM_GLOBALEYEPOS, RENDERPARM_MVPMATRIX_X, RENDERPARM_MVPMATRIX_Y, RENDERPARM_MVPMATRIX_Z, RENDERPARM_MVPMATRIX_W, RENDERPARM_MODELMATRIX_X, RENDERPARM_MODELMATRIX_Y, RENDERPARM_MODELMATRIX_Z, RENDERPARM_MODELMATRIX_W, RENDERPARM_AMBIENT_COLOR, RENDERPARM_GLOBALLIGHTORIGIN, RENDERPARM_JITTERTEXSCALE, RENDERPARM_JITTERTEXOFFSET, RENDERPARM_CASCADEDISTANCES };

const idList<bindingLayoutType_t, TAG_RENDER> rpMaximalSet8Layouts = { BINDING_LAYOUT_AMBIENT_LIGHTING_IBL, BINDING_LAYOUT_AMBIENT_LIGHTING_IBL_SKINNED };

const idList<renderParm_t, TAG_RENDER> rpMaximalSet9 = { RENDERPARM_DIFFUSEMODIFIER, RENDERPARM_SPECULARMODIFIER, RENDERPARM_LOCALLIGHTORIGIN, RENDERPARM_LOCALVIEWORIGIN, RENDERPARM_LIGHTPROJECTION_S, RENDERPARM_LIGHTPROJECTION_T, RENDERPARM_LIGHTPROJECTION_Q, RENDERPARM_LIGHTFALLOFF_S, RENDERPARM_BUMPMATRIX_S, RENDERPARM_BUMPMATRIX_T, RENDERPARM_DIFFUSEMATRIX_S, RENDERPARM_DIFFUSEMATRIX_T, RENDERPARM_SPECULARMATRIX_S, RENDERPARM_SPECULARMATRIX_T, RENDERPARM_VERTEXCOLOR_MODULATE, RENDERPARM_VERTEXCOLOR_ADD, RENDERPARM_MVPMATRIX_X, RENDERPARM_MVPMATRIX_Y, RENDERPARM_MVPMATRIX_Z, RENDERPARM_MVPMATRIX_W };

const idList<bindingLayoutType_t, TAG_RENDER> rpMaximalSet9Layouts = { BINDING_LAYOUT_DRAW_INTERACTION, BINDING_LAYOUT_DRAW_INTERACTION_SKINNED };

const idList<renderParm_t, TAG_RENDER> rpMaximalSet10 = { RENDERPARM_SCREENCORRECTIONFACTOR, RENDERPARM_DIFFUSEMODIFIER, RENDERPARM_SPECULARMODIFIER, RENDERPARM_LOCALLIGHTORIGIN, RENDERPARM_LOCALVIEWORIGIN, RENDERPARM_LIGHTPROJECTION_S, RENDERPARM_LIGHTPROJECTION_T, RENDERPARM_LIGHTPROJECTION_Q, RENDERPARM_LIGHTFALLOFF_S, RENDERPARM_BUMPMATRIX_S, RENDERPARM_BUMPMATRIX_T, RENDERPARM_DIFFUSEMATRIX_S, RENDERPARM_DIFFUSEMATRIX_T, RENDERPARM_SPECULARMATRIX_S, RENDERPARM_SPECULARMATRIX_T, RENDERPARM_VERTEXCOLOR_MODULATE, RENDERPARM_VERTEXCOLOR_ADD, RENDERPARM_MVPMATRIX_X, RENDERPARM_MVPMATRIX_Y, RENDERPARM_MVPMATRIX_Z, RENDERPARM_MVPMATRIX_W, RENDERPARM_MODELMATRIX_X, RENDERPARM_MODELMATRIX_Y, RENDERPARM_MODELMATRIX_Z, RENDERPARM_MODELMATRIX_W, RENDERPARM_MODELVIEWMATRIX_X, RENDERPARM_MODELVIEWMATRIX_Y, RENDERPARM_MODELVIEWMATRIX_Z, RENDERPARM_MODELVIEWMATRIX_W, RENDERPARM_GLOBALLIGHTORIGIN, RENDERPARM_JITTERTEXSCALE, RENDERPARM_JITTERTEXOFFSET, RENDERPARM_CASCADEDISTANCES, RENDERPARM_SHADOW_MATRIX_0_X, RENDERPARM_SHADOW_MATRIX_0_Y, RENDERPARM_SHADOW_MATRIX_0_Z, RENDERPARM_SHADOW_MATRIX_0_W, RENDERPARM_SHADOW_MATRIX_1_X, RENDERPARM_SHADOW_MATRIX_1_Y, RENDERPARM_SHADOW_MATRIX_1_Z, RENDERPARM_SHADOW_MATRIX_1_W, RENDERPARM_SHADOW_MATRIX_2_X, RENDERPARM_SHADOW_MATRIX_2_Y, RENDERPARM_SHADOW_MATRIX_2_Z, RENDERPARM_SHADOW_MATRIX_2_W, RENDERPARM_SHADOW_MATRIX_3_X, RENDERPARM_SHADOW_MATRIX_3_Y, RENDERPARM_SHADOW_MATRIX_3_Z, RENDERPARM_SHADOW_MATRIX_3_W, RENDERPARM_SHADOW_MATRIX_4_X, RENDERPARM_SHADOW_MATRIX_4_Y, RENDERPARM_SHADOW_MATRIX_4_Z, RENDERPARM_SHADOW_MATRIX_4_W, RENDERPARM_SHADOW_MATRIX_5_X, RENDERPARM_SHADOW_MATRIX_5_Y, RENDERPARM_SHADOW_MATRIX_5_Z, RENDERPARM_SHADOW_MATRIX_5_W, RENDERPARM_SHADOW_ATLAS_OFFSET_0, RENDERPARM_SHADOW_ATLAS_OFFSET_1, RENDERPARM_SHADOW_ATLAS_OFFSET_2, RENDERPARM_SHADOW_ATLAS_OFFSET_3, RENDERPARM_SHADOW_ATLAS_OFFSET_4, RENDERPARM_SHADOW_ATLAS_OFFSET_5 };

const idList<bindingLayoutType_t, TAG_RENDER> rpMaximalSet10Layouts = { BINDING_LAYOUT_DRAW_INTERACTION_SM, BINDING_LAYOUT_DRAW_INTERACTION_SM_SKINNED };
...
private:
	...
	layoutAttributes_t							layoutAttributes[NUM_BINDING_LAYOUTS];
	idList<bindingLayoutType_t, TAG_RENDER>		renderParmLayouts[RENDERPARM_TOTAL];
	nvrhi::IDevice*								device;

	nvrhi::BindingLayoutHandle uniformsLayout( bindingLayoutType_t layout, bool skinning );
