...
const idList<bindingLayoutType_t, TAG_RENDER> rpMinimalSet2LayoutTypes = { BINDING_LAYOUT_POST_PROCESS_FINAL, BINDING_LAYOUT_DRAW_AO, BINDING_LAYOUT_DRAW_AO1 };

// SRS - Limit rpNominalSets to maximum of 15 idVec4 entries (15*16 = 240 bytes) to fit within D3D12 root constant limit
const idList<renderParm_t, TAG_RENDER> rpNominalSet3 = { RENDERPARM_BUMPMATRIX_S, RENDERPARM_BUMPMATRIX_T, RENDERPARM_VERTEXCOLOR_MODULATE, RENDERPARM_VERTEXCOLOR_ADD, RENDERPARM_MVPMATRIX_X, RENDERPARM_MVPMATRIX_Y, RENDERPARM_MVPMATRIX_Z, RENDERPARM_MVPMATRIX_W, RENDERPARM_MODELVIEWMATRIX_X, RENDERPARM_MODELVIEWMATRIX_Y, RENDERPARM_MODELVIEWMATRIX_Z };
...
const idList<bindingLayoutType_t, TAG_RENDER> rpNominalSet6LayoutTypes = { BINDING_LAYOUT_SSGI, BINDING_LAYOUT_SSGI_SKINNED };

// SRS - Limit rpNominalSets to maximum of 15 idVec4 entries (15*16 = 240 bytes) to fit within D3D12 root constant limit
const idList<renderParm_t, TAG_RENDER> rpNominalSet7 = { RENDERPARM_COLOR, RENDERPARM_MVPMATRIX_X, RENDERPARM_MVPMATRIX_Y, RENDERPARM_MVPMATRIX_Z, RENDERPARM_MVPMATRIX_W, RENDERPARM_TEXGEN_0_S, RENDERPARM_TEXGEN_0_T, RENDERPARM_TEXGEN_0_Q, RENDERPARM_TEXGEN_1_S, RENDERPARM_TEXGEN_1_T };
